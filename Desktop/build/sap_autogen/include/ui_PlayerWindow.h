...
public:
    ...
    void setupUi(QMainWindow *PlayerWindow)
    {
        ...
        formLayoutWidget->setGeometry(QRect(590, 60, 361, 84));
        ...
        authorLabel->setMinimumSize(QSize(116, 42));
        authorLabel->setMaximumSize(QSize(116, 16777215));
        authorLabel->setAlignment(Qt::AlignBottom|Qt::AlignLeading|Qt::AlignLeft);
        ...
        narratorLabel->setAlignment(Qt::AlignBottom|Qt::AlignLeading|Qt::AlignLeft);
