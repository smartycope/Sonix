...
std::vector<char> getCmdOutV(const std::string command, bool verbose = false);
static std::string getCmdOutS(const std::string command, bool verbose = false);
...
inline std::vector<char> getCmdOutV(const std::string command, bool verbose){
    FILE* pipe;
...
static std::string getCmdOutS(const std::string command, bool verbose){
    FILE* pipe;
    const char* cmd = command.c_str();
    std::string out;
    char* transportBuffer;
